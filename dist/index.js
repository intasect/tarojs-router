...
})(exports.NavigateType || (exports.NavigateType = {}));
...
function getCurrentRouteKey() {
  ...
  var params = (_Taro$getCurrentInsta = Taro__default.getCurrentInstance().router) === null || _Taro$getCurrentInsta === void 0 ? void 0 : _Taro$getCurrentInsta.params;
...
var Router = /*#__PURE__*/function () {
  ...
  Router.navigate = function navigate(route, options) {
    try {
      ...
      options = _extends({}, {
        type: exports.NavigateType.navigateTo,
        params: {}
      }, options);
      ...
      return Promise.resolve(fn({
        ...
        return new Promise(function (res, rej) {
          ...
          switch (options.type) {
            case exports.NavigateType.reLaunch:
              Taro__default.reLaunch({
                url: url
              });
              break;

            case exports.NavigateType.redirectTo:
              Taro__default.redirectTo({
                url: url
              });
              break;

            case exports.NavigateType.switchTab:
              Taro__default.switchTab({
                url: url
              });
              break;

            default:
              Taro__default.navigateTo({
                url: url
              });
              break;
          }
  ...
  Router.back = function back(route) {
    ...
    var currentPages = Taro__default.getCurrentPages();

    if (currentPages.length > 1) {
      return Taro__default.navigateBack();
    }
    ...
    if (route) {
      return Router.navigate(route, {
        type: exports.NavigateType.redirectTo
      });
    } else {
...
function useRouter(defaultParams) {
  ...
  var _useRouterTaro = Taro.useRouter(),
